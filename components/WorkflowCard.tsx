    ...
    <div className="light-card rounded-2xl p-6 flex flex-col justify-between hover:shadow-lg hover:-translate-y-1 transition-all duration-300 animate-fadeIn">
      <div>
        {workflow.ai_generated && (
          <div className="flex items-center text-xs font-medium text-[#2b9e91] mb-2">
      ...
      <div className="flex items-center gap-2 mt-4">
        <button
          ...
          className="w-full text-center custom-button text-white font-semibold py-2.5 px-4 rounded-lg transition-colors text-sm shadow-sm"
        >
          View Workflow
        </button>
      </div>
